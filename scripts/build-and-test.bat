...
if not exist "!AGENTCTL_RELEASE_EXE!" (
    echo [FAIL] Enrollment helper is missing: !AGENTCTL_RELEASE_EXE!
    exit /b 1
)
echo ============================================================
echo [5/6] npm ci...
