...
grep -Fq '[System.Management.Automation.Language.NullString]::Value' "$RUNNER"
grep -Fq '[IO.File]::Replace($temporary, $targetPath, [System.Management.Automation.Language.NullString]::Value)' "$RUNNER"
