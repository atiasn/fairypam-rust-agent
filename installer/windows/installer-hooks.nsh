...
; Older Tauri installers emitted resource ancestors child-first. Those failed installers
...
!macro NSIS_HOOK_ACTIVATE
  ...
  IfFileExists "$FairyPamInstallDir\fairypam-agent-shell.exe" 0 fairypam_install_validation_failed
  IfFileExists "$FairyPamInstallDir\fairypam-win32-worker.exe" 0 fairypam_install_validation_failed
  IfFileExists "$FairyPamInstallDir\runtime\maa\active.json" 0 fairypam_install_validation_failed
